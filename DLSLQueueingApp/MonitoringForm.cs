...
namespace DLSLQueueingApp
{
    public partial class MonitoringForm : Form
    {
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/1_Cashier_NextQueue1.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/1_Cashier_NextQueue2.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/1_Cashier_NextQueue3.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/1_Cashier_NextQueue4.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/1_Cashier_NextQueue5.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/2_Cashier_NextQueue1.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/2_Cashier_NextQueue2.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/2_Cashier_NextQueue3.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/2_Cashier_NextQueue4.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/2_Cashier_NextQueue5.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/3_Cashier_NextQueue1.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/3_Cashier_NextQueue2.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/3_Cashier_NextQueue3.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/3_Cashier_NextQueue4.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/3_Cashier_NextQueue5.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/4_Cashier_NextQueue1.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/MonitoringDisplay/4_Cashier_NextQueue2.php");
            var responseString = await queueData.Content.ReadAsStringAsync();
            String data = responseString;
            ServiceClass[] collection = JsonConvert.DeserializeObject<ServiceClass[]>(data);
            if (collection == null)
