...
{
    public partial class TicketForm4_Mobile_PriorityOthersTicketPrinting : Form
    {
        public TicketForm4_Mobile_PriorityOthersTicketPrinting()
        {
            InitializeComponent();
        }

        private void TicketForm4_Mobile_PriorityOthersTicketPrinting_Load(object sender, EventArgs e)
        {
            ...
            studentNumber.Text = TicketForm2_2_1_2PriorityLane.studentNumberHolder;
            queueNumber.Text = TicketForm2_2_1_2PriorityLane.queueNoHolder.ToString();
            if (TicketForm2_2_1_2PriorityLane.numberOfQueueCashier1 == 0)
            {
                queueNumber.Text = TicketForm2_2_1_2PriorityLane.numberOfQueueCashier2.ToString();
                cashierNumber.Text = "2";
            }
            else if (TicketForm2_2_1_2PriorityLane.numberOfQueueCashier2 == 0)
            {
                queueNumber.Text = TicketForm2_2_1_2PriorityLane.numberOfQueueCashier1.ToString();
                cashierNumber.Text = "1";
            }
            else if (TicketForm2_2_1_2PriorityLane.numberOfQueueCashier3 == 0)
            {
                queueNumber.Text = TicketForm2_2_1_2PriorityLane.numberOfQueueCashier4.ToString();
                cashierNumber.Text = "4";
            }
            else if (TicketForm2_2_1_2PriorityLane.numberOfQueueCashier4 == 0)
            {
                queueNumber.Text = TicketForm2_2_1_2PriorityLane.numberOfQueueCashier3.ToString();
