...
{
    public partial class QueueingForm3 : Form
    {
        public QueueingForm3()
        {
            InitializeComponent();
        }
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/fetchCashier3TotalQueueData.php");
        ...
        {
            HttpResponseMessage updateResponse = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/cashier3_updateQueueViaNo.php");
