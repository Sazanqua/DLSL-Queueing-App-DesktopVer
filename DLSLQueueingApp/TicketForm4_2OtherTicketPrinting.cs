...
{
    public partial class TicketForm4_2OtherTicketPrinting : Form
    {
        public TicketForm4_2OtherTicketPrinting()
        {
            InitializeComponent();
        }
        private static readonly HttpClient client = new HttpClient();

        private async void TicketForm4_2OtherTicketPrinting_Load(object sender, EventArgs e)
        {
