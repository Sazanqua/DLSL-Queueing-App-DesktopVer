...
{
    public partial class TicketForm4_Mobile_PriorityCollegeTicketPrinting : Form
    {
        public TicketForm4_Mobile_PriorityCollegeTicketPrinting()
        {
            InitializeComponent();
        }

        private void TicketForm4_Mobile_PriorityCollegeTicketPrinting_Load(object sender, EventArgs e)
        {
