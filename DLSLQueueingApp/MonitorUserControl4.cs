...
namespace DLSLQueueingApp
{
    public partial class MonitorUserControl4 : UserControl
    {
        ...
        public MonitorUserControl4()
        {
            ...
            String query = "SELECT cashier_number, queue_no, queueing_status, service_type, service_lane FROM service WHERE cashier_number=4 AND queueing_status='PENDING' UNION SELECT cashier_number, queue_no, queueing_status, service_type, service_lane FROM service_manual WHERE cashier_number = 4 AND queueing_status='PENDING' ORDER BY service_lane = 'PRIORITY' DESC, queue_no ASC; ";
