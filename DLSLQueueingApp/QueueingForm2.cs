...
namespace DLSLQueueingApp
{
    public partial class QueueingForm2 : Form
    {
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/fetchCashier2TotalQueueData.php");
        ...
        {
            HttpResponseMessage updateResponse = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/cashier2_updateQueueViaNo.php");
