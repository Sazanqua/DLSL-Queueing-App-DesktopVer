...
namespace DLSLQueueingApp
{
    public partial class QueueingForm4 : Form
    {
        ...
        {
            HttpResponseMessage queueData = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/fetchCashier4TotalQueueData.php");
        ...
        {
            HttpResponseMessage updateResponse = await client.GetAsync("http://dlslqueueingapp-merwincastromjc253154.codeanyapp.com/v1/cashier4_updateQueueViaNo.php");
