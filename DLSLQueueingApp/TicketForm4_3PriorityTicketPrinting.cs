...
{
    public partial class TicketForm4_3PriorityTicketPrinting : Form
    {
        public TicketForm4_3PriorityTicketPrinting()
        {
            InitializeComponent();
        }
        private static readonly HttpClient client = new HttpClient();

        private async void TicketForm4_3PriorityTicketPrinting_Load(object sender, EventArgs e)
        {
